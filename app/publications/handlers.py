...
async def get_all_publications(session: AsyncSession = Depends(get_async_api_session)):
...
async def get_all_favorites(
        ...
        session: AsyncSession = Depends(get_async_api_session)
):
...
async def get_publication_prices(pub_id: int, session: AsyncSession = Depends(get_async_api_session)):
